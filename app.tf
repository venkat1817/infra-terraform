...
resource "aws_lb_target_group_attachment" "app-attach-tg" {
...
resource "aws_lb_listener" "dev-front_end" {
...
resource "aws_route53_record" "dev-app" {
  zone_id = aws_route53_zone.kkmn-hostedzone.zone_id
  name    = "dev-app.kkmn.info"
  type    = "A"
  ttl     = "300"
